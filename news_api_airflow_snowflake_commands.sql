...
ENABLED = TRUE
STORAGE_ALLOWED_LOCATIONS = ('gcs://snowflake_projects_test12/news_data_analysis/parquet_files/')
;

DESC INTEGRATION news_data_gcs_integration;

CREATE OR REPLACE STAGE gcs_raw_data_stage
URL = 'gcs://snowflake_projects_test12/news_data_analysis/parquet_files/'
